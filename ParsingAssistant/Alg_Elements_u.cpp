...
void TtoD_Line_u::PrintLine()
{
	...
	case TypeOfTtoDLine::HYPOTHESIS:
		cout << rule_num.GetPrintable() << " HYPOTHESIS " << endl;
		break;
	case TypeOfTtoDLine::WRONG_HYPO:
		cout << rule_num.GetPrintable() << " WRONG_HYPO " << endl;
		break;
	case TypeOfTtoDLine::MISTAKE:
		cout << rule_num.GetPrintable() << " MISTAKE " << endl;
		break;
	case TypeOfTtoDLine::RECOGNIZED:
		cout << rule_num.GetPrintable() << " RECOGNIZED " << endl;
		break;
	case TypeOfTtoDLine::PARSED_END_TtoD:
		cout << rule_num.GetPrintable() << " PARSED_END " << endl;
		break;
	case TypeOfTtoDLine::NOT_PARSED_END_TtoD:
		cout << rule_num.GetPrintable() << " NOT_PARSED_END " << endl;
		break;
	}
}
